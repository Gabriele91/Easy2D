...
void LuaState::addEasy2DLib()
{
    ...
    .beginNamespace("Screen")
	    .addFunction("setOrientation",    (setUInt)    [](uint e)  {         Application::instance()->get_screen()->setOrientation((Screen::Orientation)e); })
		.addFunction("getOrientation",    (getUInt)    []()->uint  {  return (uint)Application::instance()->get_screen()->getOrientation(); })
		.addFunction("getWidth",          (getUInt)    []()->uint  {  return Application::instance()->get_screen()->getWidth(); })
		.addFunction("getHeight",		  (getUInt)    []()->uint  {  return Application::instance()->get_screen()->getHeight(); })
		.addFunction("getNativeWidth",    (getUInt)    []()->uint  {  return Application::instance()->get_screen()->getNativeWidth(); })
		.addFunction("getNativeHeight",   (getUInt)    []()->uint  {  return Application::instance()->get_screen()->getNativeHeight(); })
        .addFunction("getSize",           (getVec2)    []()->Vec2  {  return Application::instance()->get_screen()->getSize(); })
		.addFunction("setCursor",		  (setBool)    [](bool e)  {         Application::instance()->get_screen()->setCursor(e); })
		.addFunction("getCursor",         (getBool)      []()->bool  {  return Application::instance()->get_screen()->getCursor(); })
		.addFunction("setPositionCursor", (setVec2)      [](Vec2 v)  {         Application::instance()->get_screen()->setPositionCursor(v); })
        .addFunction("setFullscreen",     (setBool)      [](bool f)  {         Application::instance()->get_screen()->setFullscreen(f); })
		.addFunction("isFullscreen",      (getBool)      []()->bool  {  return Application::instance()->get_screen()->isFullscreen(); });

    /// Input
    luabridge::getGlobalNamespace(luaVM)
        .beginNamespace("Input")
		.addFunction("getMouse",         (getVec2)[]()->Vec2            {  return Application::instance()->get_input()->getMouse(); })
		.addFunction("getFinger",   (getKey2Input)[](int finger)->Vec2  {  return Application::instance()->get_input()->getFinger((Key::Finger)finger); })
		.addFunction("getKeyDown",   (getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getKeyDown((Key::Keyboard)key); })
		.addFunction("getKeyUp",     (getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getKeyUp((Key::Keyboard)key); })
		.addFunction("getKeyHit",    (getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getKeyHit((Key::Keyboard)key); })
		.addFunction("getMouseDown", (getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getMouseDown((Key::Mouse)key); })
		.addFunction("getMouseUp",   (getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getMouseUp((Key::Mouse)key); })
		.addFunction("getMouseHit",  (getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getMouseHit((Key::Mouse)key); })
		.addFunction("getFingerDown",(getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getFingerDown((Key::Finger)key); })
		.addFunction("getFingerUp",  (getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getFingerUp((Key::Finger)key); })
		.addFunction("getFingerHit", (getKeyInput)[](int key)->bool     {  return Application::instance()->get_input()->getFingerHit((Key::Finger)key); })
		.addFunction("getFocus",        (getBool) []()->bool            {  return Application::instance()->get_input()->getFocus(); })
		.addFunction("getMinimized",    (getBool) []()->bool            {  return Application::instance()->get_input()->getMinimized(); })
		.addFunction("getMaximized",    (getBool) []()->bool            {  return Application::instance()->get_input()->getMaximized(); })
		.addFunction("getClose",        (getBool) []()->bool            {  return Application::instance()->get_input()->getClose(); })
		.addFunction("getResize",       (getBool) []()->bool            {  return Application::instance()->get_input()->getResize(); })
		.addFunction("getResizeValues", (getVec2) []()->Vec2            {  return Application::instance()->get_input()->getResizeValues(); })

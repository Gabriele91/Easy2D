...
public:
    ...
    DFORCEINLINE uint getRealWidth()
    {
        return realWidth;
    }
    DFORCEINLINE uint getSpriteWidth()
    {
        return spriteWidth;
    }
    DFORCEINLINE uint getHeight()
    {
        return height;
    }
    DFORCEINLINE uint getRealHeight()
    {
        return realHeight;
    }
    DFORCEINLINE uint getSpriteHeight()
    {
        return spriteHeight;
    }
